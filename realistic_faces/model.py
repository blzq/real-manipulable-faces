...
def gen_face_batch(shape_mean, shape_basis, expr_basis, batch_size):
    shape_params = tf.random.normal([batch_size. shape_basis.shape[1]], stddev=10.)
    expr_params = tf.random.normal([batch_size, expr_basis.shape[1]], stddev=10.)
...
def render_face_batch(verts, mesh_faces):
